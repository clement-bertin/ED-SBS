# Running instructions for ED-SBS v2.0
...
Note: ED-SBS v2.0 runs on darwin checkpoint v68o (commit 628b4a6)

```
git clone https://github.com/darwinproject/darwin3.git
git checkout 628b4a6
```
...
../tools/genmake2 -mpi -mo '../../setup_files_v2.0/code_darwin ../../setup_files_v2.0/code'
make depend
make -j 16
```
